    ...
    <script>
        ...
        const node = svg.selectAll(".node")
            ...
            .attr("class", d => {
                let nodeClass = "node";
                if (d.data.estado) {
                    nodeClass += ` node-${d.data.estado.replace('_', '-')}`;
                }
                return nodeClass;
            })
        ...
        function showTooltip(event, d) {
            ...
            if (d.data.estado) {
                const estado = d.data.estado.replace('_', ' ');
                html += `<p><strong>Estado:</strong> <span style="text-transform: capitalize;">${estado}</span></p>`;
            }
