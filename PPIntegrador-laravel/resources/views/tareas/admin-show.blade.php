...
<!-- Botón de regresar -->
<a href="{{ route('proyectos.ramas.admin', $tarea->rama->proyecto) }}"
   class="mt-4 inline-flex items-center text-sm font-medium text-[#C7B8E0] hover:text-[#E0AAFF] transition-all">
    <i class="fas fa-arrow-left mr-2"></i> Volver a las ramas
</a>
    </div>
    </div>
